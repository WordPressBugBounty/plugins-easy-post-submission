...
if ( ! function_exists( 'easy_post_submission_admin_description_strings' ) ) {
	...
	function easy_post_submission_admin_description_strings() {
		...
		return [
			...
			'typeAnything'                         => esc_html__( 'type anything', 'easy-post-submission' ),
			...
			'enableTags'                           => esc_html__( 'Enable Tags', 'easy-post-submission' ),
			'enableTagsDesc'                       => esc_html__( 'Enable the tags input field in the submission form.', 'easy-post-submission' ),
			...
			'globalRecaptchaSettings'              => esc_html__( 'Global Captcha Settings', 'easy-post-submission' ),
			'captchaType'                          => esc_html__( 'Captcha Type', 'easy-post-submission' ),
			'captchaTypeDesc'                      => esc_html__( 'Select the captcha service to use for verification.', 'easy-post-submission' ),
			'captchaTypeNone'                      => esc_html__( 'None', 'easy-post-submission' ),
			'captchaTypeRecaptcha'                 => esc_html__( 'Google reCAPTCHA v2', 'easy-post-submission' ),
			'captchaTypeTurnstile'                 => esc_html__( 'Cloudflare Turnstile', 'easy-post-submission' ),
			'turnstileSiteKey'                     => esc_html__( 'Turnstile Site Key', 'easy-post-submission' ),
			'turnstileSiteKeyDesc'                 => esc_html__( 'Input the Cloudflare Turnstile Site Key.', 'easy-post-submission' ),
			'turnstileSiteKeyPlaceholder'          => esc_html__( 'Enter your Turnstile Site Key', 'easy-post-submission' ),
			'turnstileSecretKey'                   => esc_html__( 'Turnstile Secret Key', 'easy-post-submission' ),
			'turnstileSecretKeyDesc'               => esc_html__( 'Input the Cloudflare Turnstile Secret Key.', 'easy-post-submission' ),
			'turnstileSecretKeyPlaceholder'        => esc_html__( 'Enter your Turnstile Secret Key', 'easy-post-submission' ),
...
if ( ! function_exists( 'easy_post_submission_description_strings' ) ) {
	...
	function easy_post_submission_description_strings() {
		...
		return [
			...
			'hintYourName'                         => esc_html__( 'Enter your full name as you would like it to appear.', 'easy-post-submission' ),
			'yourEmail'                            => esc_html__( 'Your Email', 'easy-post-submission' ),
			'hintYourEmail'                        => esc_html__( 'Your email address will not be publicly displayed. It is used solely for administrative purposes and to contact you about your post.', 'easy-post-submission' ),
			...
			'hintPostTitle'                        => esc_html__( 'Short and sweet is the way to go! Try to keep your post title between 50 and 70 characters to make it more engaging.', 'easy-post-submission' ),
			'addPostExcerpt'                       => esc_html__( 'Add Excerpt', 'easy-post-submission' ),
			'hintPostExcerpt'                      => esc_html__( 'Aim for a length of about 20 to 55 words. A concise excerpt captures the essence of your post without giving everything away.', 'easy-post-submission' ),
			...
			'hintPostContent'                      => esc_html__( 'Begin with a captivating introduction that grabs your readers attention and gives them a reason to keep reading.', 'easy-post-submission' ),
			...
			'hintPostCategories'                   => esc_html__( 'Choose categories that accurately reflect your post content.', 'easy-post-submission' ),
			...
			'hintPostTags'                         => esc_html__( 'Choose tags that are most relevant to your post content.', 'easy-post-submission' ),
			...
			'verifyFailedCaptchaMessage'           => esc_html__( 'Captcha verification failed', 'easy-post-submission' ),
			'turnstileLoadFailed'                  => esc_html__( 'Failed to load Turnstile', 'easy-post-submission' ),
